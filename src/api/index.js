...
import ax, { getAuthorization } from './axios'
...
// 添加音乐
export const addMusic = (params = {}) => ax.put('music/add', { ...params })

// 获取音乐
export const fetchMusic = (params = {}) => ax.get('music/get', { params })

// 删除留言墙
export const delMusic = id => ax.delete(`music/delect/${id}`)

// 编辑留言墙
export const editeMusic = (id, params = {}) => ax.post(`music/edite/${id}`, {...params})

// 上传配置
export const uploadConfig = () => ({
  action: `${config.API_ROOT}music/upload`,
  headers: {
