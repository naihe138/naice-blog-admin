    ...
    return (
      <div className={panelClass}>
        ...
        <div className={editorClass}>
          <textarea ref="editor" name="content" onChange={this._onChange.bind(this)}></textarea>{/* style={{height: this.state.editorHeight + 'px'}} */}
        </div>
  ...
  _getToolBar () {
    return (
      <ul className="md-toolbar clearfix">
        <li className="tb-btn"><a title="加粗" onClick={this._boldText.bind(this)}><i className="fa fa-bold"></i></a></li>{/* bold */}
        <li className="tb-btn"><a title="斜体" onClick={this._italicText.bind(this)}><i className="fa fa-italic"></i></a></li>{/* italic */}
        <li className="tb-btn spliter"></li>
        <li className="tb-btn"><a title="链接" onClick={this._linkText.bind(this)}><i className="fa fa-link"></i></a></li>{/* link */}
        <li className="tb-btn"><a title="引用" onClick={this._blockquoteText.bind(this)}><i className="fa fa-outdent"></i></a></li>{/* blockquote */}
        <li className="tb-btn"><a title="代码段" onClick={this._codeText.bind(this)}><i className="fa fa-code"></i></a></li>{/* code */}
        <li className="tb-btn"><a title="图片" onClick={this._pictureText.bind(this)}><i className="fa fa-picture-o"></i></a></li>{/* picture-o */}
        <li className="tb-btn spliter"></li>
        <li className="tb-btn"><a title="有序列表" onClick={this._listOlText.bind(this)}><i className="fa fa-list-ol"></i></a></li>{/* list-ol */}
        <li className="tb-btn"><a title="无序列表" onClick={this._listUlText.bind(this)}><i className="fa fa-list-ul"></i></a></li>{/* list-ul */}
        <li className="tb-btn"><a title="标题" onClick={this._headerText.bind(this)}><i className="fa fa-header"></i></a></li>{/* header */}
  ...
  _getModeBar () {
    ...
    return (
      <ul className="md-modebar">
        ...
        <li className="tb-btn pull-right"><a title="全屏模式" onClick={this._toggleFullScreen.bind(this)}><i className="fa fa-arrows-alt"></i></a></li> {/* full-screen */}
      </ul>
    )
  }
  // event handlers
